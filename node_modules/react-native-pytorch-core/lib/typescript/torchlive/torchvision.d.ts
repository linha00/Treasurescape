...
declare type TransformFn = (tensor: Tensor) => Tensor;
declare type TransformForwardFn = {
    forward: TransformFn;
};
export declare type Transform = TransformFn & TransformForwardFn;
declare type InterpolationMode = 'bilinear' | 'nearest' | 'bicubic';
/**
...
export interface Transforms {
     ...
     */
    resize(size: number | [number] | [number, number], interpolation?: InterpolationMode, maxSize?: number, antialias?: boolean): Transform;
}
interface Torchvision {
    transforms: Transforms;
}
export declare const torchvision: Torchvision;
export {};
